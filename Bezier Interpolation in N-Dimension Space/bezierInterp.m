% % A function for Bezier interpolation for a given set of four control
% % points. Each control point can exist in an N-dimensional vector space.
% % Optionally, the parameter values t can be passed as a 1-D array, in which
% % case the Bezier curve will be evaluated at the specified values in t. By
% % default, the Bezier curve is evaluated at 101 evenly spaced values
% % between 0 and 1. The output of the function is a set of evaluated points
